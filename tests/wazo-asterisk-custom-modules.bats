...
setup() {
	...
	export WAZO_UPGRADE_ASTERISK_MODULES_DIR="$BATS_TEST_TMPDIR/modules"
	export WAZO_UPGRADE_ASTERISK_MD5SUMS_FILE="$BATS_TEST_TMPDIR/asterisk.md5sums"
	ASTERISK_MODULES_DIR="$WAZO_UPGRADE_ASTERISK_MODULES_DIR"
	ASTERISK_MD5SUMS_FILE="$WAZO_UPGRADE_ASTERISK_MD5SUMS_FILE"
